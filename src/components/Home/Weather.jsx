...
const Api_key = "9e632ecc2e4d24e69dd52f4985b0d765";
const Weather = () => {
...
return (
    ...
    <div className="bg-gray-800 h-screen grid place-items-center">
        ...
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" ><Link to={"/table"} >Table</Link></button>
